...
function init() {
    html_mesa = "<div id=\'mesa\' style=\'overflow:hidden;position:absolute;background-image: url(\"" + mesa.imagem + "\");background-repeat: no-repeat;background-size: " + mesa.largura_total + "px " + mesa.altura_total + "px;height:" + mesa.altura_total + "px;width:" + mesa.largura_total + "px;margin-top:0px;margin-left:0px\'></div>";
...
$(document).ready(function() {
    ...
    init();
    window.setTimeout(function() {fInitGameTest()}, 500);
});
...
function fInitGameTest() {
    ...
    fAddCardToSlot('card1', 0, "As");
    fAddCardToSlot('card2', 0, "Kd");
    /*window.setTimeout('fCardsDown(0,\'card2\')', 6 * 1000);
    window.setTimeout('fCardsDown(0,\'card1\')', 8 * 1000);
    window.setTimeout('fCardsUp(0,\'card1\')', 10 * 1000);
    window.setTimeout('fCardsUp(0,\'card2\')', 12 * 1000);*/
    fAddCardToSlot('card1', 1, "Qh");
    ...
    fLocalPlayerTurn('2.00', '4.00', '201.00', ['FOLD', 'CALL', 'RAISE'], '15.00');
};
...
function fUpdatePlayerTurn(sitPosition, timetoAct) {
    ...
    for (i = 0; i <= globalTableSize - 1; i++) {
        ...
        if ((document.getElementById(`pisca${i}`).style.visibility == 'visible') && (sitPosition != i)) {
            ...
            console.log("Chamando principal->secundária para sitPosition:" + i)
            anima_principal(i, 'principal->secundaria');
        }
    }
    document.getElementById(`seatName${sitPosition}`).style.fontWeight = "bold";
    console.log("Chamando secundária->principal para sitPosition:" + sitPosition)
    anima_principal(sitPosition, 'secundaria->principal');
