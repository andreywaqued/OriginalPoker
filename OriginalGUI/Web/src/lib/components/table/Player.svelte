<script>
	...
	let updateLastActionShowed = (lastAction) => {
		...
		if (lastActionShowed != lastAction && lastAction != '') {
			...
			actionShowingTimeout = setTimeout(() => {
	...
	let positioningClass =
		positionClassByTableSize[tableSize][(position - tableRotateAmount + tableSize) % tableSize];
	$: console.log(
		`(${position} - ${tableRotateAmount} + ${tableSize}) % ${tableSize}: ${
			(position - tableRotateAmount + tableSize) % tableSize
		}`
	);
	$: console.log(positioningClass);
	$: positioningClass =
		positionClassByTableSize[tableSize][(position - tableRotateAmount + tableSize) % tableSize]; //needs to be done like this to become reactive to changes
	// console.log(positioningClass)
...
<div class={positioningClass}>
	<div
		class="player"
		class:fold={hasFolded && handIsBeingPlayed}
		class:sitout={isSitout && (tableClosed || !handIsBeingPlayed)}
	>
		...
		<div
			...
			class:value={!showValuesInBB}
			class:valueInBB={showValuesInBB}
		>
			<span>{stackSize}</span>
		</div>
		<!-- {Math.round(stackSize * 100) / 100} -->
		{#if betSize > 0}
			<div class="playerBet">
				<span>{showValuesInBB ? '' : '$ '}{betSize}{showValuesInBB ? ' BB' : ''}</span>
			</div>
		{/if}
		{#if showCards}
			<div
				class="playerCardsHero"
				class:show={playerCardsShow}
				class:fold={hasFolded && isHero}
				bind:this={playerCardsHero}
			>
				{#each cards as card}
					<div class="card"><Card cardString={card} {deck} /></div>
				{/each}
...
<style lang="scss">
	...
	@keyframes glow {
		...
		10% {
			background: radial-gradient(rgba(255, 255, 255, 1), rgba(255, 255, 255, 0) 50.5%);
		}
		20% {
			background: radial-gradient(rgba(255, 255, 255, 1), rgba(255, 255, 255, 0) 51%);
		}
		30% {
			background: radial-gradient(rgba(255, 255, 255, 1), rgba(255, 255, 255, 0) 51.5%);
		}
		40% {
			background: radial-gradient(rgba(255, 255, 255, 1), rgba(255, 255, 255, 0) 52%);
		}
		50% {
			background: radial-gradient(rgba(255, 255, 255, 1), rgba(255, 255, 255, 0) 52.5%);
		}
		60% {
			background: radial-gradient(rgba(255, 255, 255, 1), rgba(255, 255, 255, 0) 53%);
		}
		70% {
			background: radial-gradient(rgba(255, 255, 255, 1), rgba(255, 255, 255, 0) 53.5%);
		}
		80% {
			background: radial-gradient(rgba(255, 255, 255, 1), rgba(255, 255, 255, 0) 54%);
		}
		90% {
			background: radial-gradient(rgba(255, 255, 255, 1), rgba(255, 255, 255, 0) 54.5%);
		}
		100% {
			background: radial-gradient(rgba(255, 255, 255, 1), rgba(255, 255, 255, 0) 55%);
		}
