...
import TitleBar from "$lib/Title_Bar.svelte";
    ...
    let gamesAvaiable = [
        {gameTitle: "NL 10", blinds: "$0.05 / $0.10", players: 125, minBuyin: "$2.00", maxBuyin: "10.00"},
        {gameTitle: "NL 50", blinds: "$0.25 / $0.50", players: 85, minBuyin: "$10.00", maxBuyin: "50.00"},
        {gameTitle: "NL 100", blinds: "$0.50 / $1.00", players: 35, minBuyin: "$20.00", maxBuyin: "100.00"},
        {gameTitle: "NL 200", blinds: "$1.00 / $2.00", players: 1025, minBuyin: "$40.00", maxBuyin: "200.00"}
    ]
     ...
     */
    function openNewTable(tableName) {
        api.send("open-new-table", tableName)
    }
    ...
    <div class="mainDiv">
        <div class="playerInfo">
            ...
            <div class="player">
                ...
                <div class="playerName"><span>ASDS1</span></div>
            </div>
            <div class="cashier">
        ...
        <div class="main">
            ...
            <div class="gameDiv">
                ...
                <div class="gamesAvaiable">
                    {#if tabSelected === 0}
                        {#each gamesAvaiable as game, index}
                        <div class="wrapper" on:mouseenter={() => changeDoordashClass(index)} on:mouseleave={() => changeDoordashClass(index)}>
                            ...
                            <div class="gameSelector" >
                                ...
                                <div class="buttonDiv">
                                    <button class="joinNow" on:click={()=>openNewTable(game.gameTitle)}>JOIN NOW</button>
                                </div>
                            </div>
                        </div>
                        {/each}
