...
class Table {
    ...
    startNewRound() {
        ...
        this.putBetsIntoPot()
        if (this.currentHand.playersFolded === this.playerIDByPositionIndex.length - 1) return this.evaluteHand()
        ...
        if (this.currentHand.boardRound === 4) return console.log(this.evaluteHand())
